...
class BrokerConnectionRepositoryTest {
    ...
    @Test
    void persistsEncryptedSecretAndDeletesItWithConnection() {
        ...
        Number secretCount = (Number) entityManager.getEntityManager()
                .createNativeQuery("SELECT COUNT(*) FROM broker_connection_secrets")
                .getSingleResult();
        assertThat(secretCount.longValue()).isEqualTo(1L);
