...
- [x] 분봉 이력·SEC 접수 시각·거시 vintage 실측 결과(수행분과 미수행분 구분). — 분봉 1차·SEC(AAPL·MSFT)·ALFRED(월간·분기 4개) 완료. 일간 지표 vintage, 소형주 공시 지연, 분봉 후속 3건은 미수행으로 보고서에 구분.
...
- 3차(2026-09-23): `research/scripts/engine-data-probe/alfred_vintage_probe.py` 추가, ALFRED 결과를 커버리지 보고서 2-1절에 기록(사용자 실행 16:01 KST, 키 미기록). 월간·분기 지표는 94~100%(실업률 42%)가 발표 후 개정되고 발표까지 34~118일(관측 기간 시작 기준) 걸려, 최신 CSV를 관측일 기준으로 쓰면 미래 정보가 섞인다.
- 4차(2026-09-23 16:07~16:18 KST): 도구 보완(SEC 신고자 구분, 분봉 거래량·`--dates`·`--count`·`--before-time`·`--twelve-dates`, ALFRED 연도별 실시간 기간 분할). 소형·비가속 신고자 4종목(10-K 60일 초과 50~82%, 75일 초과 6~17%), 일간 지표 DGS10·BAA10Y(발표 1일, 개정 0.07~0.5%), 국내 1분봉 2022-01-14부터 실제 체결(공개 FAQ 시작일보다 이름), Twelve Data 1분봉 2021-06은 있고 2020-03 이전은 400.
- Open decision or risk: 미국 1분봉 프리마켓 포함 여부(18:00 KST 이후 재실행). 국내 1분봉 시작일이 문서와 달라 제공자 확인 필요. 합격 수치 후보는 남은 실측 후 제안. 후속 실측 3건(국내 2022년 봉 거래량, 미국 프리마켓 포함 여부, Twelve Data 1분봉 이력 깊이). 공개 문서와 2026-09-23 일봉 1차 관측 가설의 불일치는 2차 관측 후 판단.
