...
- Open decision or risk: 일간 지표 vintage 재조회, 소형주 공시 지연 미실측. 합격 수치 후보는 남은 실측 후 제안. 후속 실측 3건(국내 2022년 봉 거래량, 미국 프리마켓 포함 여부, Twelve Data 1분봉 이력 깊이). 공개 문서와 2026-09-23 일봉 1차 관측 가설의 불일치는 2차 관측 후 판단.
